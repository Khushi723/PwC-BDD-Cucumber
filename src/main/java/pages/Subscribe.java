 ...
 */
    public void clickReCapcha()
    {
    	...
    	WebDriverExtensions.FrameToBeAvailableToSwitch(recaptchaFrameLocator(), 60);
        WebDriverExtensions.ElementToBeClickable(recaptchaLogo(), 60);
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("arguments[0].click();", recaptchaLogo());   
    }
