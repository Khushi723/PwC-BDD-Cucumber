 ...
 * @return elemnt
 */
	public static WebElement ElementToBeClickable(WebElement element, int timeOutInSec)
    {
 ...
 * @return drivr
 */
	public static WebDriver FrameToBeAvailableToSwitch(By locator, int timeOutInSec)
    {
        WebDriverWait wait = new WebDriverWait(driver, timeOutInSec);
